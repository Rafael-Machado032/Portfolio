...
// teste
    return (
        <div className="flex flex-col max-w-90 justify-center items-center min-h-[430.2px] rounded-2xl text-white bg-gray-500 dark:bg-[#222222] border border-[#00f1fe00] hover:border-[#00f2fe] dark:hover:border-[#00f2fe] hover:shadow-[0_0_20px_rgba(0,133,140,0.6)] dark:hover:shadow-[0_0_20px_rgba(0,242,242,0.6)] hover:scale-105 transition-all duration-300">
